...
const identitynumber = (document.getElementById('identitynumber') as HTMLInputElement).value;
...
<p><b>Identity Number: </b><span contenteditable="true">${identitynumber}</span></p>
...
(document.getElementById('fathername') as HTMLInputElement).value = resumeData.fathernamename;
(document.getElementById('identitynumber') as HTMLInputElement).value = resumeData.identitynumber;
