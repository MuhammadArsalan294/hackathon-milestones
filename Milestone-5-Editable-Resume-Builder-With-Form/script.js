...
window.addEventListener('DOMContentLoaded', function () {
    ...
    if (username) {
        ...
        if (savedResumeData) {
            ...
            document.getElementById('fathername').value = resumeData.fathernamename;
            document.getElementById('identitynumber').value = resumeData.identitynumber;
